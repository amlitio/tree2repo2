  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-400 font-sans selection:bg-[#00FF85]/30 scroll-smooth relative overflow-x-hidden">
      <Head>
        ...
        <meta
          name="description"
          content="Synthesize visual ASCII diagrams into downloadable repository structures instantly."
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className="fixed top-[-10%] left-[-10%] w-[600px] h-[600px] bg-[#00FF85]/5 blur-[120px] rounded-full pointer-events-none z-0 opacity-40" />
      <div className="fixed bottom-0 right-[-5%] w-[500px] h-[500px] bg-emerald-900/10 blur-[100px] rounded-full pointer-events-none z-0 opacity-30" />
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#050505]/70 backdrop-blur-xl px-6">
        <div className="max-w-7xl mx-auto h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              href="#tool"
              className="bg-[#00FF85] px-5 py-2.5 rounded-xl text-black text-xs font-black hover:bg-emerald-400 transition-all shadow-lg shadow-[#00FF85]/10"
            >
              Launch Engine
            </a>
          </div>
      ...
      <main className="relative z-10">
        <section className="px-6 pt-40 pb-32 text-center max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-2xl text-zinc-500 max-w-3xl mx-auto mb-12 leading-relaxed font-medium">
            Stop manually creating boilerplate folders. Tree2Repo instantly converts visual diagrams
            into structured, ready-to-code local repositories.
          </p>

          <a
            href="#tool"
            className="px-10 py-5 bg-[#00FF85] text-black font-black text-xl rounded-2xl shadow-[0_0_40px_rgba(0,255,133,0.3)] hover:shadow-[0_0_60px_rgba(0,255,133,0.5)] transition-all hover:-translate-y-1 inline-flex items-center gap-3"
          >
        ...
        <section id="tool" className="px-6 py-24 max-w-7xl mx-auto border-t border-white/5">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div className="text-left">
              ...
              <p className="text-zinc-500 text-sm mt-1 italic opacity-80">
                Design your architecture. Download the package.
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 w-full md:w-auto bg-white/5 p-1.5 rounded-2xl border border-white/5">
              {['python', 'react', 'node'].map((t) => (
                <button
                  ...
                  className={`flex-1 md:flex-none px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all hover:text-white ${
                    treeText === TEMPLATES[t] ? 'bg-white/10 text-[#00FF85]' : 'text-zinc-500'
                  }`}
                >
                  {t}
                </button>
            ...
            <div className="bg-[#0c0c0c] border border-white/10 rounded-[2.5rem] overflow-hidden backdrop-blur-3xl shadow-2xl flex flex-col group transition-all hover:border-[#00FF85]/30">
              <div className="px-8 py-5 border-b border-white/5 flex items-center justify-between text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em]">
                ...
                <div className="flex gap-1.5">
                  ...
                  <div className="w-2.5 h-2.5 rounded-full bg-[#00FF85]/40" />
                </div>
              </div>
                ...
                {preview.length === 0 ? (
                  ...
                  preview.map((item, i) => (
                    <div
                      ...
                      className="flex items-center gap-4 transition-all hover:translate-x-1"
                    >
        ...
        <section id="features" className="px-6 py-32 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-left">
          <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed font-medium">
              Handles pipes, tabs, and box-drawing characters natively. Strips inline comments
              automatically.
            </p>
          </div>
          ...
          <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed font-medium">
              Our stack-based depth engine handles 20+ levels of directory complexity with zero
              fragmentation.
            </p>
          </div>
          ...
          <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed font-medium">
              Synthesis happens in your browser&apos;s RAM using JSZip for total privacy and speed.
            </p>
          </div>
        </section>
      </main>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-[#0a0a0a] border border-white/10 p-12 rounded-[3rem] max-w-md w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <p className="text-zinc-500 font-medium mb-10 leading-relaxed text-sm">
              Synthesis complete. Check your <b>Downloads</b> folder for the ZIP file.
            </p>

            <button
              onClick={() => setShowModal(false)}
              className="w-full py-5 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all"
            >
              Close System
            </button>
          </div>
