...
export default function Tree2Repo() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-400 font-sans selection:bg-[#00FF85]/30 scroll-smooth relative overflow-x-hidden">
      <Head>
        <title>Tree2Repo | Modern Repository Scaffolder</title>
        <meta name="description" content="Instantly convert ASCII directory trees into downloadable repository packages." />
      ...
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#050505]/70 backdrop-blur-xl px-6">
        <div className="max-w-7xl mx-auto h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-widest">
            <a href="#features" className="text-zinc-500 hover:text-[#00FF85] transition-colors">Features</a>
            <a href="#tool" className="bg-[#00FF85] px-5 py-2.5 rounded-xl text-black font-black hover:bg-emerald-400 transition-all shadow-lg shadow-[#00FF85]/10">Launch Engine</a>
          </div>
        </div>
      </nav>
      ...
      <main className="relative z-10">
        ...
        <section className="px-6 pt-40 pb-32 text-center max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-2xl text-zinc-500 max-w-3xl mx-auto mb-12 leading-relaxed font-medium">
            Stop manually creating boilerplate folders. Tree2Repo instantly converts visual diagrams into structured, ready-to-code repositories.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <a href="#tool" className="w-full sm:w-auto px-10 py-5 bg-[#00FF85] text-black font-black text-xl rounded-2xl shadow-[0_0_40px_rgba(0,255,133,0.3)] hover:shadow-[0_0_60px_rgba(0,255,133,0.5)] transition-all hover:-translate-y-1 inline-flex items-center gap-3 uppercase tracking-tighter">
              Start Building Free <ArrowRight className="w-6 h-6 stroke-[3]" />
            </a>
          </div>
        </section>
            ...
            <div className="bg-[#0c0c0c] border border-white/10 rounded-[2.5rem] overflow-hidden backdrop-blur-3xl shadow-2xl flex flex-col group transition-all hover:border-[#00FF85]/30">
              <div className="px-8 py-5 border-b border-white/5 flex items-center justify-between">
                ...
                <div className="flex gap-1.5">
                  ...
                  <div className="w-2 h-2 rounded-full bg-[#00FF85]/40"></div>
                </div>
              </div>
              <textarea
                ...
                {preview.length === 0? (
                  ...
                  preview.map((item, i) => (
                    <div key={i} style={{ paddingLeft: `${item.depth * 28}px` }} className="flex items-center gap-4 transition-all hover:translate-x-1">
                      <span className="text-zinc-600 text-lg opacity-60">
                        {item.isFolder? '📁' : '📄'}
                      </span>
        ...
        <section id="features" className="px-6 py-32 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
           <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
              ...
              <h3 className="text-white font-black text-xl">Intelligent Parsing</h3>
              <p className="text-sm text-zinc-500 leading-relaxed font-medium">Handles pipes, tabs, and box-drawing characters natively. Strips inline comments automatically for a clean export.</p>
           </div>
           <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
              <Layers className="text-[#00FF85] w-10 h-10" />
              <h3 className="text-white font-black text-xl">Infinite Depth</h3>
              <p className="text-sm text-zinc-500 leading-relaxed font-medium">Our depth engine handles 20+ levels of directory complexity with zero fragmentation or path errors.</p>
           </div>
           <div className="p-10 bg-white/[0.02] border border-white/10 rounded-[2.5rem] space-y-6 hover:bg-white/[0.04] transition-all">
              <Cpu className="text-[#00FF85] w-10 h-10" />
              <h3 className="text-white font-black text-xl">Local Generation</h3>
              <p className="text-sm text-zinc-500 leading-relaxed font-medium">Synthesis happens in your browser's RAM using JSZip. No logs, no server, total privacy and speed.</p>
           </div>
        </section>
      </main>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md flex items-center justify-center z- p-4">
          <div className="bg-[#0a0a0a] border border-white/10 p-12 rounded-[3rem] max-w-md w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <p className="text-zinc-500 font-medium mb-10 leading-relaxed text-sm">Your architecture has been processed. Check your <b>Downloads</b> folder for the ZIP file.</p>
      ...
      <footer className="px-6 py-16 border-t border-white/5 text-center text-[10px] text-zinc-700 font-black tracking-[0.4em] uppercase">
        &copy; 2026 Tree2Repo &bull; Build 04.09 &bull; Vercel Production
      </footer>
    </div>
  );
}